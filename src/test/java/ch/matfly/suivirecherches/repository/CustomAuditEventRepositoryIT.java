...
import ch.matfly.suivirecherches.config.audit.AuditEventConverter;
import ch.matfly.suivirecherches.domain.PersistentAuditEvent;
...
import static ch.matfly.suivirecherches.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
