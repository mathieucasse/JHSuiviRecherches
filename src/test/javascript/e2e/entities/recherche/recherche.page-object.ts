...
export class RechercheUpdatePage {
  ...
  async offredeserviceSelectLastOption(): Promise<void> {
    await this.offredeserviceSelect.all(by.tagName('option')).last().click();
  }
  ...
  async resoffredeserviceSelectLastOption(): Promise<void> {
    await this.resoffredeserviceSelect.all(by.tagName('option')).last().click();
  }
  ...
  async entPrestataireSelectLastOption(): Promise<void> {
    await this.entPrestataireSelect.all(by.tagName('option')).last().click();
  }
  ...
  async entFinaleSelectLastOption(): Promise<void> {
    await this.entFinaleSelect.all(by.tagName('option')).last().click();
  }
